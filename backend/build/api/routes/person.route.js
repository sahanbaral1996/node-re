...
exports.default = (app) => {
    app.use('/person', authentication_1.default, privateAuthenticationRouter);
    privateAuthenticationRouter.post('/', celebrate_1.celebrate({ [celebrate_1.Segments.BODY]: person_validator_1.createPersonValidator }), personController.createPerson);
};
